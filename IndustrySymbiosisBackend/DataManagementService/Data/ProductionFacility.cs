...
namespace DataManagementService.Data
{
    public class ProductionFacility
    {
        ...
        public ProductionFacility(int productionFacilityId, int enterpriseId, string facilityName, string postAddressRecord1, string postAddressRecord2,  string street, string houseNumber, string postcode, string city)
        {
